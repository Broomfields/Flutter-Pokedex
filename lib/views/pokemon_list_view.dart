...
class PokemonListView extends StatefulWidget {
  ...
  PokemonListView(this.pokedex, {Key key, this.title}) : super(key: key);
                  ...
                  return GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Hero(
                        ...
                        child: Card(
                          child: Padding(
                            padding: const EdgeInsets.only(top: 5.0, bottom: 10.0, left: 13.0, right: 22.0),
                            child: Row(
                              ...
                              children: <Widget>[
                                      ...
                                      child: 
                                        Container(
                                          ...
                                          image: DecorationImage(
                                            fit: BoxFit.cover,
                                            image: ((widget.pokedex.pokemonList[index].discovered == true) ? 
                                              (NetworkImage(widget.pokedex.pokemonList[index].img)) : 
                                              (NetworkImage("https://cdn.bulbagarden.net/upload/d/dc/GO_Pok%C3%A9_Ball.png"))
                                            )
                                          )
                                        ),
                                      ),
                                ...
                                Column(children: <Widget>[Container(width: 20)],), //Spacing

                                Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: <Widget>[

                                    PokeTitle((widget.pokedex.pokemonList[index].discovered == true) ? (widget.pokedex.pokemonList[index].name) : ("Undiscovered")),
